  ...
  try {
    ...
    if (axios.isAxiosError(error) && error.code === 'ECONNABORTED') {
      ...
      try {
        ...
        // TODO: 재시도 성공이면 보완 이벤트: client_timeout_recovered
        // fetch(`${process.env.API_BASE}/log`, {
        //   method: 'POST',
        ...
        // TODO: 재시도도 실패 → client_timeout_failed (인터셉터에서도 처리되지만 안전망)
        // fetch(`${process.env.API_BASE}/log`, {
        //   method: 'POST',
        //   headers: { 'Content-Type': 'application/json' },
        //   body: JSON.stringify({
